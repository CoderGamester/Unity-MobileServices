...
| Area | Provides |
| --- | --- |
| Native UI | Alerts, action sheets, toasts, review requests, and sharing |
...
The editor simulator is for exercising application paths; it is not a substitute for device permission, notification-delivery, review, or native-build validation.
