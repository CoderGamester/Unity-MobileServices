...
- **Editor diagnostics** — `Enable Haptics Debug Logs` (**OFF by default**) writes Editor haptics play/stop calls to the Console when diagnostic visibility is needed. It never affects player builds or native error reporting.
